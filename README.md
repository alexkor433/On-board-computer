...
- v2.9.4.1 Изменил логику включения светодиода и пьезоэлемента в настройках, увеличение быстродействия меню, убрал флаг однократного чтения из EEPROM
при входе в меню настроек, изменил очередность параметров в меню, убрал условие, при котором не производилась запись моточасов при нулевом напряжении:
