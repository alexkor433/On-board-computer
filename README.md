...
- v3.1.4 Применение библиотеки  GyverIO для ускоренной работы с портами ввода-вывода, улучшения (printFromPGM, функции обработки меню),
исправление лага вывода напряжения после выхода из меню (20.04). //3.05.24 
