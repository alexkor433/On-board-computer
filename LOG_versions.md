...
меню, применены 1-байтные переменнные для таймера обновления тахометра (решена проблема с направильной работой таймера с переменными типа uint8_t), перенёс код обработки
