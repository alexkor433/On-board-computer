...
- v0.1 работа с LCD 1602, подключение tm1637; //.2021
...
- v3.1.1 Улучшение в функции обработки меню, оптимизация считывания количества нажатий кнопки (getClicks()); //2.09.2023
- v3.1.2 Поддержка версии 3.3 EncButton (EB_NO_FOR, EB_NO_CALLBACK); //9.09.23
- v3.1.3 Исправлен баг с неправильным выводом сообщения о превышении температуры, поддержка режима аварийной сигнализации указателей поворота, улучшение кода указателей поворота,
изменение таймаута управления светодиодом (1400 -> 2000) после включения указателей поворота для избежания наложения включений светодиода,
улучшение читаемости кода (разделение на структурные элементы), другие улучшения. //5.04.24 