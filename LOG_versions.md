...
- v2.9.5.2 После включения поворота код вывода информации выполняется один раз, добавил настройку частоты пассивной пищалки buzzFrq и I2C адреса LCD1602 lcdAddr. //26.02.23 